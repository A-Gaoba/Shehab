  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-gradient-to-br from-gray-700 to-gray-800 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 group border-2 border-white/20 flex items-center justify-center"
        aria-label="إعدادات الثلج"
      >
        <Snowflake className="w-5 h-5 text-white group-hover:animate-spin transition-transform duration-300" />
      </button>
