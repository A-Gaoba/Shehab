          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="mb-8 space-y-4">
              ...
              <p className="text-lg text-blue-200 max-w-2xl mx-auto leading-relaxed">
                استكشف جمال موسكو التاريخية، استمتع بشواطئ سوتشي الساحرة، واغمر نفسك في ثقافة سانت بطرسبرغ العريقة مع أفضل شركة سياحة روسية للعرب
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <h3 className="text-2xl font-bold mb-2">خدمة 5 نجوم</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button 
                className="bg-white/20 backdrop-blur-sm text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/30 transition-all duration-300 border border-white/30"
